...
let voice = new p5.Speech("Arthur"); // speech synthesis object set to the voice "Bad News"
...
let song;
// Implement a queue for managing speech synthesis
...
function setup() {
  ...
  voice.setVoice("Arthur"); //the bot's voice selection
  voice.setRate(1); //how fast it speaks
